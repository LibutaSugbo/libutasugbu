...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Verification/Libuta Sugbu</title>
    <link rel="stylesheet" href="/css/nicepage.css" media="screen">
<link rel="stylesheet" href="/css/Verification.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-custom-color-1 u-header u-sticky u-sticky-9732 u-header" id="sec-aada"><a href="{{ url('/home') }}" class="u-image u-logo u-image-1" data-image-width="497" data-image-height="190">
    ...
    <section class="u-clearfix u-section-1" id="sec-b932">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-container-style u-group u-opacity u-opacity-85 u-palette-5-dark-1 u-shape-rectangle u-group-1">
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            <p class="u-text u-text-palette-2-light-3 u-text-1">VERIFICATION</p>
          </div>
        </div>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="sec-35d8">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-left u-border-3 u-border-grey-40 u-container-style u-group u-group-1">
          <div class="u-container-layout u-valign-bottom u-container-layout-1">
            <h3 class="u-text u-text-default u-text-1">Enter an active email for verification:&nbsp;</h3>
            <h6 class="u-text u-text-2">We will verify your email, please wait for 5 days and check your email for confirmation</h6>
            <div class="u-border-2 u-border-grey-75 u-form u-radius-16 u-form-1">
              <form action="#" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;" source="custom" name="form">
                <div class="u-form-email u-form-group">
                  <label for="email-6797" class="u-label">Email verification:</label>
                  <input type="email" placeholder="Email" id="email-6797" name="verify_email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
                </div>
            ...
            <a href="{{ url('/subscription') }}" data-page-id="767024717" class="u-border-2 u-border-hover-palette-1-base u-border-palette-1-base u-btn u-btn-round u-button-style u-hover-palette-1-base u-none u-radius-50 u-btn-2">next</a>
          </div>
        </div>
      </div>
    </section>
