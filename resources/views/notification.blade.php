...
<html style="font-size: 16px">
  <head>
    ...
    <link rel="stylesheet" href="/css/Notifications.css" media="screen" />
    <script
      class="u-script"
  ...
  <body class="u-body">
    ...
    <section class="u-clearfix u-section-1" id="sec-45ba">
          ...
          <table class="u-table-entity">
            ...
            <tbody class="u-table-body">
              <tr style="height: 51px">
                ...
                <td class="u-border-5 u-border-grey-dark-1 u-table-cell"></td>
              </tr>
              <tr style="height: 51px">
                <td
                  class="
              ...
              <tr style="height: 51px">
                <td
                  class="
                    u-border-5 u-border-custom-color-1 u-grey-5 u-table-cell
                  "
                >
                  Check-out date
                </td>
    ...
    <section class="u-clearfix u-section-2" id="sec-2ffe">
