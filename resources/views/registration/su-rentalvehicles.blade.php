...
<html style="font-size: 16px;">
  <head>
    ...
    <title>SU-Rental Vehicles/Libuta Sugbu</title>
    <link rel="stylesheet" href="/css/nicepage.css" media="screen">
<link rel="stylesheet" href="/css/SU-RentalVehicles.css" media="screen">
    ...
    <link id="u-page-google-font" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i|Roboto+Slab:100,200,300,400,500,600,700,800,900">
    ...
    <meta name="twitter:title" content="SU-RentalVehicles">
    <meta name="twitter:description" content="LibutaSugbo">
    <meta property="og:title" content="SU-RentalVehicles">
  ...
  <body class="u-body"><header class="u-clearfix u-custom-color-1 u-header u-sticky u-sticky-9732 u-header" id="sec-aada"><a href="{{ url('/home') }}" class="u-image u-logo u-image-1" data-image-width="497" data-image-height="190">
...
</li><li class="u-nav-item"><a class="u-border-2 u-border-active-white u-border-hover-grey-10 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-radius-10 u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90" href="{{ url('/signup') }}"  style="padding: 10px;">Sign-up</a>
</li></ul>
        </div>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ url('/signup') }}"  style="padding: 10px;">Sign-up</a>
</li></ul>
            </div>
          </div>
    ...
    <section class="u-clearfix u-section-1" id="sec-f64f">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-container-style u-group u-opacity u-opacity-85 u-palette-5-dark-1 u-shape-rectangle u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <p class="u-text u-text-palette-2-light-3 u-text-1">
              <span style="font-size: 1.875rem;">SIGN-UP AS: </span>RENTAL VEHICLES
            </p>
          </div>
        </div>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="sec-e2cd">
        ...
        <div class="signup-form u-align-right u-border-3 u-border-grey-75 u-form u-palette-5-light-3 u-radius-14 u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-5 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 36px;">
            ...
            <div class="u-form-group u-form-group-3">
              <label for="text-765d" class="u-label">Display Name</label>
              <input type="text" placeholder="Display Name" id="text-765d" name="display_name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            </div>
            ...
            <div class="u-form-email u-form-group u-form-group-10">
            ...
            <div class="u-form-group u-form-group-11">
              ...
              <input type="text" placeholder="Enter your password" id="passworda" name="password" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
            </div>
            ...
            <div class="u-form-group u-form-textarea u-form-group-13">
              <label for="textarea-2e6f" class="u-label">About you</label>
              <textarea rows="4" cols="50" id="textarea-2e6f" name="about" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" placeholder="Talk about you..."></textarea>
            </div>
    ...
    <section class="u-clearfix u-section-3" id="sec-edc6">
