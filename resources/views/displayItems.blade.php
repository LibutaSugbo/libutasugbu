...
<html style="font-size: 16px">
  ...
  <body class="u-body">
    ...
    <section class="u-clearfix u-section-1" id="sec-d54c">
          ...
          <div class="u-repeater u-repeater-1">
            ...
            >
              ...
              >
                ...
                />
                <h5 class="u-text u-text-default u-text-1">West Cottage</h5>
                <h6 class="u-text u-text-default u-text-2">MAX:&nbsp;</h6>
                <h6 class="u-text u-text-default u-text-3">8 person</h6>
            ...
            >
              ...
              >
                <img
                  ...
                  src="https://pixabay.com/get/gbeadc75aa104c7a1b62fec92c90cfedcc193c5b6111d67e8796b0a8ea77480d6ddee3b5bdb1fe29b78ce440a878819d5331984943c5a2e3958062a8aa9041978_1280.jpg"
                  alt=""
                  data-image-width="1280"
                  data-image-height="852"
                />
                <h5 class="u-text u-text-default u-text-5">West Cottage</h5>
                <h6 class="u-text u-text-default u-text-6">MAX:&nbsp;</h6>
                <h6 class="u-text u-text-default u-text-7">8 person</h6>
            ...
            >
              ...
              >
                <img
                  ...
                  data-image-height="852"
                />
                <h5 class="u-text u-text-default u-text-9">West Cottage</h5>
                <h6 class="u-text u-text-default u-text-10">MAX:&nbsp;</h6>
                <h6 class="u-text u-text-default u-text-11">8 person</h6>
            ...
            >
              ...
              >
                <img
                  ...
                  data-image-height="852"
                />
                <h5 class="u-text u-text-default u-text-13">West Cottage</h5>
                <h6 class="u-text u-text-default u-text-14">MAX:&nbsp;</h6>
                <h6 class="u-text u-text-default u-text-15">8 person</h6>
                <h6 class="u-text u-text-default u-text-16">
                  <b>₱&nbsp;</b>2,000.00
                </h6>
                <a
                  href="https://nicepage.app"
            ...
            >
              ...
              >
                <img
                  ...
                  data-image-height="852"
                />
                <h5 class="u-text u-text-default u-text-17">West Cottage</h5>
                <h6 class="u-text u-text-default u-text-18">MAX:&nbsp;</h6>
                <h6 class="u-text u-text-default u-text-19">8 person</h6>
                <h6 class="u-text u-text-default u-text-20">
                  <b>₱&nbsp;</b>2,000.00
                </h6>
                <a
                  href="https://nicepage.app"
            ...
            >
              ...
              >
                <img
                  ...
                  data-image-height="852"
                />
                <h5 class="u-text u-text-default u-text-21">West Cottage</h5>
                <h6 class="u-text u-text-default u-text-22">MAX:&nbsp;</h6>
                <h6 class="u-text u-text-default u-text-23">8 person</h6>
                <h6 class="u-text u-text-default u-text-24">
                  <b>₱&nbsp;</b>2,000.00
                </h6>
                <a
                  href="https://nicepage.app"
