...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="/css/nicepage-home.css" media="screen">
<link rel="stylesheet" href="/css/SU-RentalVehicles.css" media="screen">
    <script class="u-script" type="text/javascript" src="/js/jquery-1.js" defer=""></script>
      ...
      <div class="u-clearfix u-sheet u-valign-bottom u-sheet-1">
        ...
        @endif   
          ...
          <div class="u-form-group u-form-name">
              ...
              <input type="text" placeholder="First name" id="first_name" name="first_name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white form-control @error('first_name') is-invalid @enderror" required="required">
              @error('first_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="u-form-group u-form-group-2">
              ...
              <input type="text" placeholder="Last name" id="last_name" name="last_name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white form-control @error('last_name') is-invalid @enderror" required="required">
              @error('last_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="u-form-group u-form-group-2">
              ...
              <input type="text" placeholder="Middle name" id="mid_name" name="mid_name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white form-control @error('mid_name') is-invalid @enderror" >
              @error('mid_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="u-form-group u-form-group-2">
              ...
              <input type="text" placeholder="Extension name" id="ext_name" name="ext_name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white form-control @error('ext_name') is-invalid @enderror" >
              @error('ext_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
