  ...
  <body class="u-body"><header class="u-clearfix u-custom-color-1 u-header u-sticky u-sticky-9732 u-header" id="sec-aada"><a href="{{ url('/home') }}" class="u-image u-logo u-image-1" data-image-width="497" data-image-height="190">
    ...
    <section class="u-clearfix u-section-2" id="sec-a69b">
      <div class="u-clearfix u-sheet u-valign-top u-sheet-1">
        ...
        @endif   
          <form action="{{ url('storeSu_tourspot') }}" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-5 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 36px;" redirect="true">
          @csrf
