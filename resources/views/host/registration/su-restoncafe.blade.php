...
<html style="font-size: 16px">
  <head>
    ...
    <title>SU-RestoNCafe/Libuta Sugbu</title>
    <link rel="stylesheet" href="/css/nicepage-home.css" media="screen" />
    <link rel="stylesheet" href="/css/SU-RestoNCafe.css" media="screen" />
    <script
      class="u-script"
    ...
    <link
      ...
      rel="stylesheet"
      href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i|Roboto+Slab:100,200,300,400,500,600,700,800,900"
    />
    ...
    <meta name="twitter:title" content="SU-RestoNCafe" />
    <meta name="twitter:description" content="LibutaSugbo" />
    <meta property="og:title" content="SU-RestoNCafe" />
  ...
  <body class="u-body">
    ...
    >
      ...
      <nav
        class="u-menu u-menu-dropdown u-offcanvas u-offcanvas-shift u-menu-1"
        data-responsive-from="XS"
        data-position="Nav"
      >
        <div
          class="menu-collapse u-custom-font u-font-roboto-slab"
          style="
            font-size: 1.25rem;
            letter-spacing: 0px;
          ...
          >
            <li class="u-nav-item">
              <a
                class="
                  u-border-2
                  u-border-active-white
                  u-border-hover-grey-10
                  u-border-no-left
                  u-border-no-right
                  u-border-no-top
                  u-button-style
    ...
    <section class="u-clearfix u-section-1" id="sec-d024">
        ...
        >
          <div class="u-container-layout u-container-layout-1">
            <p class="u-text u-text-palette-2-light-3 u-text-1">
              SIGN-UP AS: RESTO/CAFE
            </p>
          </div>
        </div>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="sec-897e">
    ...
    @endif   
      <form action="{{ url('storeSu_restoncafe') }}" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-5 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 36px;" redirect="true">
      @csrf
      <div class="u-form-group u-form-name">
        <label for="name-20d2" class="u-label">Resto/Cafe Name</label>
